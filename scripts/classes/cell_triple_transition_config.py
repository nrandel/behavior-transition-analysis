...
def extract_windows(
    ...
    for ctc in tqdm(cell_transition_configs, "Extracting windows"):
        ...
        behavior_columns = set(
            ...
            if any(behavior in column for behavior in AVAILABLE_BEHAVIORS + ("quiet", "time",))
        )
